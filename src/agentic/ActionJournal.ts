...
export class ActionJournal {
     ...
     */
    async getActionsByTool(toolName: string, limit: number = 50): Promise<AgentAction[]> {
        const actions = await this.typedDb
            .selectFrom(this.actionsTable as any)
            .selectAll()
     ...
     */
    async getFailureReport(): Promise<{ toolName: string, failureCount: number, lastFailure: string }[]> {
