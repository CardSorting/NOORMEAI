...
const index_type_node_js_1 = require("../../operation-node/index-type-node.js");
...
class CreateIndexBuilder {
    ...
    using(indexType) {
        return new CreateIndexBuilder({
            ...this.#props,
            node: create_index_node_js_1.CreateIndexNode.cloneWith(this.#props.node, {
                using: index_type_node_js_1.IndexTypeNode.is(indexType)
                    ? indexType
                    : index_type_node_js_1.IndexTypeNode.create(indexType),
            }),
        });
    }
    where(...args) {
