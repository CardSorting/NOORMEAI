...
exports.sql = Object.assign((sqlFragments, ...parameters) => {
    ...
    ref(columnReference) {
        ...
        (0, security_validator_js_1.validateColumnReference)(columnReference);
        return (0, raw_builder_js_1.createRawBuilder)({
            queryId: (0, query_id_js_1.createQueryId)(),
    ...
    table(tableReference) {
        // Security validation to prevent SQL injection
        (0, security_validator_js_1.validateTableReference)(tableReference);
        return (0, raw_builder_js_1.createRawBuilder)({
            queryId: (0, query_id_js_1.createQueryId)(),
    ...
    id(...ids) {
        ...
        ids.forEach((id, index) => {
            (0, security_validator_js_1.validateIdentifier)(id, `identifier[${index}]`);
        });
