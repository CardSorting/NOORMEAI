...
export class PolicyEnforcer {
     ...
     */
    async checkPolicy(name: string, value: any): Promise<{ allowed: boolean, reason?: string }> {
     ...
     */
    async evaluateContext(context: Record<string, any>): Promise<{ allowed: boolean, violations: string[] }> {
    ...
    private async getCumulativeMetric(metricName: string, period: 'daily' | 'hourly' | 'all'): Promise<number> {
