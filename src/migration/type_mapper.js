...
exports.POSTGRES_TO_SQLITE_TYPES = exports.SQLITE_TO_POSTGRES_TYPES = void 0;
exports.mapType = mapType;
exports.getValueTransformation = getValueTransformation;
 ...
 */
function mapType(sourceType, sourceDialect, targetDialect) {
    // Normalize type name
    ...
    if (sourceDialect === 'sqlite' && targetDialect === 'postgresql') {
        ...
        const mapped = exports.SQLITE_TO_POSTGRES_TYPES[baseType];
        if (mapped) {
    ...
    if (sourceDialect === 'postgresql' && targetDialect === 'sqlite') {
        // Extract type without length/precision
        const baseType = normalizedType.split('(')[0].trim();
        const mapped = exports.POSTGRES_TO_SQLITE_TYPES[baseType];
        if (mapped) {
            return mapped;
        }
        // Default to TEXT if no mapping found
 ...
 */
function getValueTransformation(sourceType, targetType, sourceDialect, targetDialect) {
 ...
 */
function areTypesCompatible(sourceType, targetType, sourceDialect, targetDialect) {
    if (sourceDialect === targetDialect) {
