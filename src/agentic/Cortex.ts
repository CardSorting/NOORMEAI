...
export class Cortex {
    ...
    constructor(
        ...
        this.buffer = new ContextBuffer({ maxMessages: agenticConfig.contextWindowSize })
     ...
     */
    async resumeSession(sessionId: string | number, limit: number = 20): Promise<AgentMessage[]> {
    ...
    async recordInteraction(
        ...
        await this.telemetry.track(sessionId, type as any, content, { role, messageId: message.id })
