...
export async function createSQLiteMigrationManager(
  db: any,
  config?: Partial<
    import('./sqlite-migration-manager.js').SQLiteMigrationConfig
  >,
  logger?: import('../logging/logger.js').Logger,
): Promise<import('./sqlite-migration-manager.js').SQLiteMigrationManager> {
  const { SQLiteMigrationManager } = await import(
    './sqlite-migration-manager.js'
  )
...
export async function createSQLiteMigrationProvider(
  config?: Partial<
    import('./sqlite-migration-provider.js').SQLiteMigrationProviderConfig
  >,
  logger?: import('../logging/logger.js').Logger,
): Promise<import('./sqlite-migration-provider.js').SQLiteMigrationProvider> {
  const { SQLiteMigrationProvider } = await import(
    './sqlite-migration-provider.js'
  )
