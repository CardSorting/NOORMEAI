...
export class RuleEngine {
    ...
    async defineRule(
        ...
        options: { condition?: string, priority?: number, script?: string, metadata?: Record<string, any> } = {}
    ...
    ): Promise<{ action: CognitiveRule['action'], ruleId?: string | number, reason?: string }> {
     ...
     */
    applyMasking(data: Record<string, any>, rule: CognitiveRule): Record<string, any> {
     ...
     */
    async getActiveRules(tableName: string, operation: CognitiveRule['operation']): Promise<CognitiveRule[]> {
