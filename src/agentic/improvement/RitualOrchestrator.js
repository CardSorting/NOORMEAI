...
exports.RitualOrchestrator = void 0;
/**
...
class RitualOrchestrator {
    ...
    async executeRitual(ritual) {
        ...
        const ritualMetadata = { ...ritual.metadata, startedAt: new Date() };
        let success = false;
        try {
            switch (ritual.type) {
                case 'compression':
     ...
     */
    calculateNextRun(frequency, failureCount = 0) {
...
exports.RitualOrchestrator = RitualOrchestrator;
