...
exports.SchemaEvolutionHelper = void 0;
...
class SchemaEvolutionHelper {
     ...
     */
    suggestAddColumn(tableName, columnName, columnType) {
        (0, security_validator_js_1.validateIdentifier)(tableName, 'table name');
        (0, security_validator_js_1.validateIdentifier)(columnName, 'column name');
    ...
    async applySuggestion(ddl) {
        ...
        for (const id of identifiers) {
            ...
            try {
                (0, security_validator_js_1.validateIdentifier)(id);
            }
            catch (e) {
        ...
        await sql_js_1.sql.raw(sqlToExecute).execute(this.db);
    }
    normalizeKyselyToSql(jsCode) {
...
exports.SchemaEvolutionHelper = SchemaEvolutionHelper;
